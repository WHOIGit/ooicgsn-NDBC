...
gi01sumo_name_map = {
    ...
    'avgpd': 'WAVSS MEAN_WAVE_PERIOD',
    'dompd': 'WAVSS PEAK_PERIOD',
...
if __name__ == '__main__':
    ...
    SUMO = NDBC('GI01SUMO', 'D00012', '44078', currentTime, startTime,
    ...
    metbk1_files, metbk2_files, wavss_files = get_files(BASE_PATH, 'GI01SUMO', 'D00012')
